...
def run_3d_points() -> None:
    rr.set_time_seconds("sim_time", 1)
    rr.log_point("3d_points/single_point_unlabeled", np.array([10.0, 123.0, 0.0]))
    rr.log_point("3d_points/single_point_labeled", np.array([8, 110.0, 0.0]), label="labeled point")
    # rr.log_points(
